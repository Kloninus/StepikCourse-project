...
class ProductPage(BasePage):
    ...
    def should_be_title_add_message(self):
        ...
        assert book_title == book_title_expected, f"Invalid book title, add '{book_title_expected}'" \
                                                  " but in add message '{book_title}'"
    ...
    def should_be_right_price_in_basket(self):
        ...
        assert basket_price == book_price, f"Invalid basket total price, expected '{book_price}'"\
                                           " exist '{basket_price}'"

    def should_not_be_success_message(self):
        assert self.is_not_element_present(*ProductPageLocators.BASKET_TOTAL_ADD_MESSAGE), \
            "Success message is presented, but should not be"

    def should_disappeared_success_message(self):
        assert self.is_disappeared(*ProductPageLocators.BOOK_TITLE_ADD_MESSAGE), \
            "Success message is presented, but should not be"
